...
namespace ECS_Test.Core
{
    class Swatch
    {
        ...
        public static RLColor CompilmentLightest = new RLColor(190, 180, 174);
        public static RLColor CompilmentLighter = new RLColor(158, 147, 138);
        public static RLColor Compilment = new RLColor(129, 116, 107);
        public static RLColor CompilmenteDarker = new RLColor(97, 84, 75);
        public static RLColor CompilmentDarkest = new RLColor(71, 56, 45);
